...
public class PixelPropsUtils {
    ...
    static {
        ...
        propsToChangePixel8Pro.put("ID", "AP1A.240505.004");
        propsToChangePixel8Pro.put("FINGERPRINT", "google/husky/husky:14/AP1A.240505.005.B1/11766002:user/release-keys");
